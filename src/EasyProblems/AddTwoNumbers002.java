...
public class AddTwoNumbers002 {
  public static ListNode addTwoNumber(ListNode l1, ListNode l2) {
    ...
    while(l2 != null || l1 != null || remnant != 0) {
      ...
      sum = sumTotal % 10;
      remnant = sumTotal / 10;
      // Add na EasyProblems.ListNode de retorno
...
//    l2.next = l3;
    ...
    b1.next = b2;
    b2.next = b3;
//    b1 = new EasyProblems.ListNode(6, b1);
//    b1 = new EasyProblems.ListNode(4, b1);

    String expected = "[8,0,7]";
    var newList = AddTwoNumbers002.addTwoNumber(l1, b1);
